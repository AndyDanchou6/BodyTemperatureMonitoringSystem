...
<head>
    ...
    <title>Login | Student Temperature Monitoring System</title>
                        ...
                        <form id="formAuthentication" class="mb-3" action="/loginHandler" method="POST">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="password" placeholder="Password" aria-describedby="password" /><span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                            </div>
